...
<FORM method="post" action="showHouse.jsp" name="form1" enctype="multipart/form-data">
...
<DIV class=houseinfo>
    <td><span><img src="http://localhost:80/${house.path}" width="50px" height="50px"></span></td>
