...
<TABLE class=field>
  ...
  <TR>
    ...
    <TD><INPUT class=text id="inputName" type=text name=name onblur="checkButton()"><span id="showNotice"></span><%--<input type="button" id="checkButton" value="检查用户名是否存在">--%> </TD></TR>
  <TR>
